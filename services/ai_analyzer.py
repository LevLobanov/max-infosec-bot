...
import json
import logging
from services.balance_checker import get_balance_checker, init_balance_checker
from config import get_ai_tunnel_key
...
async def analyze_message_safe(text: str) -> AnalysisResult:
    ...
    return await ai_analyzer.analyze_message(text)
